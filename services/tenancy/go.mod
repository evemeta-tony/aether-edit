// services/tenancy/go.mod
module github.com/evemeta-tony/aether-edit/services/tenancy

go 1.25

// The contracts module is landed by the FT-2 lane at services/contracts;
// this in-repo replace resolves once both branches are merged (same
// pattern as the FT-3 and FT-4 lanes).
